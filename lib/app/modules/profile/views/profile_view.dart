                                                                  ...
                                                                  children: [
                                                                    CircleAvatar(
                                                                        backgroundColor:
                                                                            Colors
                                                                                .transparent,
                                                                        backgroundImage: person.image_url.isNotEmpty
                                                                            ? NetworkImage(person
                                                                                .image_url)
                                                                            : const NetworkImage(
                                                                        ...
                                                                        child: controller.isLoading ==
                                                                                true
                                                                            ? Lottie.network('https://assets5.lottiefiles.com/private_files/lf30_esg1l8r1.json')
                                                                            : null),
                                                                    const Positioned(
                                                                        bottom:
                                                                            5,
                                                                  ...
                                                                  options: [
                                                                    ...
                                                                    FormBuilderFieldOption(
                                                                        ...
                                                                        child: Text(
                                                                            'Female',
                                                                            style:
                                                                                GoogleFonts.ibmPlexMono(fontWeight: FontWeight.w400, color: Colors.black))),
                                                                  ],
                                                                ),
                                                              ),
                                                            ],
